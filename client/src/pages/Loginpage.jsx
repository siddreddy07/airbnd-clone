...
const Loginpage = () => {
  ...
  const loginuser = async(e)=>{
    ...
    const res = await axios.post('/login',{
      ...
      if(res.status===500){
        toast.error("No user Found/Invalid Credentials")
      }
      else{
        console.log("0data")
      }
  ...
  return (
    <div className='h-screen flex items-center justify-center'>
        <div className='mx-auto mb-40 w-[80vw] sm:w-[60vw] md:w-[40vw] xl:w-[30vw] 2xl:w-[25vw] rounded-md shadow-md p-4'>
            <form action="" className='flex flex-col items-center gap-4' onSubmit={loginuser}>
            <span className='flex items-center flex-col'>
            <FaPlaneDeparture className='text-3xl xl:text-4xl text-red-500'/>
            <h1 className='text-xl text-red-500 font-bold'>Travel Mate</h1>
        </span>
